                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mt-3">
                        <div class="mb-1">
                            ...
                            <input type="text" class="form-control" name="title" value="{{$call_to_action->title ?? null}}" maxlength="35" required>
                    ...
                    <div class="col-lg-6 mt-3">
                        <div class="mb-1">
                            ...
                            <input type="text" class="form-control" maxlength="35" name="subtitle" value="{{$call_to_action->subtitle ?? null}}">
                            <div class="invalid-feedback">
