@php $map_description = $data['section_elements']['map_description']->first() @endphp
@if($map_description)
    {!! Form::open(['url'=>route($module.'section-element.update', $map_description->id),'id'=>'submit_form','class'=>'needs-validation submit_form','method'=>'PUT','novalidate'=>'','enctype'=>'multipart/form-data']) !!}
@else
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mt-3">
                        <div class="mb-1">
                            ...
                            <input type="text" class="form-control" name="title" value="{{$map_description->title ?? null}}" maxlength="35" required>
                    ...
                    <div class="col-lg-6 mt-3">
                        <div class="mb-1">
                            ...
                            <input type="text" class="form-control" maxlength="35" name="subtitle" value="{{$map_description->subtitle ?? null}}">
                            <div class="invalid-feedback">
...
<div class="text-center mt-3 mb-3">
    <button type="submit" class="btn btn-success w-sm">{{(@$map_description !== null)? "Update":"Create"}}</button>
</div>
{!! Form::close() !!}
